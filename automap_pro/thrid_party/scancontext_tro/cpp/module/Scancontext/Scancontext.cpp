...
double SCManager::distDirectSC ( const MatrixXd &_sc1, const MatrixXd &_sc2 )
{
...
int SCManager::fastAlignUsingVkey( const MatrixXd &_vkey1, const MatrixXd &_vkey2)
{
...
std::pair<double, int> SCManager::distanceBtnScanContext( const MatrixXd &_sc1, const MatrixXd &_sc2 )
{
