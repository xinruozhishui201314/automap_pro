...
inline Eigen::Vector3d rayPlaneIntersection(const Eigen::Vector3d &planeCentroid, const Eigen::Vector3d &planeNormal,
                                            const Eigen::Vector3d &rayOrigin, const Eigen::Vector3d &rayDirection)
{
