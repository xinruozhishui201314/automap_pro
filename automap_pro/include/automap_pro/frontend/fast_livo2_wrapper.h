#pragma once
/**
 * @file frontend/fast_livo2_wrapper.h
...
// ──────────────────────────────────────────────────────────
// FastLIVO2Wrapper：自研 ESIKF LiDAR-IMU 前端，非 fast_livo 官方算法。
// 与 modular 中已验证的 fast_livo（LIVMapper）不是同一实现；建图推荐使用
// frontend.mode=external_fast_livo + fast_livo 节点。
// ──────────────────────────────────────────────────────────
