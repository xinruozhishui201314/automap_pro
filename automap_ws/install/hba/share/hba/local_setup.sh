...
: ${AMENT_CURRENT_PREFIX:="/workspace/automap_ws/install/hba"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hba/environment/library_path.sh"
