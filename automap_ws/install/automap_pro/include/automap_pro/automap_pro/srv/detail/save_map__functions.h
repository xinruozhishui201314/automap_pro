...
#ifndef AUTOMAP_PRO__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_
#define AUTOMAP_PRO__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_
 ...
 * calls
 * automap_pro__srv__SaveMap_Request__init().
...
/**
 * It calls
 * automap_pro__srv__SaveMap_Request__fini()
 ...
 * automap_pro__srv__SaveMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * automap_pro__srv__SaveMap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * automap_pro__srv__SaveMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_automap_pro
...
/**
 * It calls
 * automap_pro__srv__SaveMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_automap_pro
...
/**
 * It allocates the memory for the array and calls
 * automap_pro__srv__SaveMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_automap_pro
...
/**
 * It calls
 * automap_pro__srv__SaveMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AUTOMAP_PRO__SRV__DETAIL__SAVE_MAP__FUNCTIONS_H_
