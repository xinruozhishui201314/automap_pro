...
automap_pro__srv__TriggerHBA_Request__are_equal(const automap_pro__srv__TriggerHBA_Request * lhs, const automap_pro__srv__TriggerHBA_Request * rhs)
{
  ...
  // wait_for_result
  if (lhs->wait_for_result != rhs->wait_for_result) {
    return false;
  }
  return true;
}
  ...
  automap_pro__srv__TriggerHBA_Request * output)
{
  ...
  // wait_for_result
  output->wait_for_result = input->wait_for_result;
  return true;
}
...
automap_pro__srv__TriggerHBA_Request__create()
{
  ...
  automap_pro__srv__TriggerHBA_Request * msg = (automap_pro__srv__TriggerHBA_Request *)allocator.allocate(sizeof(automap_pro__srv__TriggerHBA_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automap_pro__srv__TriggerHBA_Request));
  bool success = automap_pro__srv__TriggerHBA_Request__init(msg);
  if (!success) {
...
automap_pro__srv__TriggerHBA_Request__destroy(automap_pro__srv__TriggerHBA_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    automap_pro__srv__TriggerHBA_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
automap_pro__srv__TriggerHBA_Request__Sequence__init(automap_pro__srv__TriggerHBA_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automap_pro__srv__TriggerHBA_Request * data = NULL;

  if (size) {
    data = (automap_pro__srv__TriggerHBA_Request *)allocator.zero_allocate(size, sizeof(automap_pro__srv__TriggerHBA_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automap_pro__srv__TriggerHBA_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        automap_pro__srv__TriggerHBA_Request__fini(&data[i - 1]);
      }
...
automap_pro__srv__TriggerHBA_Request__Sequence__fini(automap_pro__srv__TriggerHBA_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      automap_pro__srv__TriggerHBA_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automap_pro__srv__TriggerHBA_Request__Sequence * array = (automap_pro__srv__TriggerHBA_Request__Sequence *)allocator.allocate(sizeof(automap_pro__srv__TriggerHBA_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automap_pro__srv__TriggerHBA_Request__Sequence__init(array, size);
  if (!success) {
...
automap_pro__srv__TriggerHBA_Request__Sequence__destroy(automap_pro__srv__TriggerHBA_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automap_pro__srv__TriggerHBA_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automap_pro__srv__TriggerHBA_Request__Sequence__are_equal(const automap_pro__srv__TriggerHBA_Request__Sequence * lhs, const automap_pro__srv__TriggerHBA_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automap_pro__srv__TriggerHBA_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automap_pro__srv__TriggerHBA_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automap_pro__srv__TriggerHBA_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automap_pro__srv__TriggerHBA_Request * data =
      (automap_pro__srv__TriggerHBA_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automap_pro__srv__TriggerHBA_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automap_pro__srv__TriggerHBA_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!automap_pro__srv__TriggerHBA_Request__copy(
...
automap_pro__srv__TriggerHBA_Response__init(automap_pro__srv__TriggerHBA_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    automap_pro__srv__TriggerHBA_Response__fini(msg);
    return false;
  }
  // elapsed_seconds
  // final_mme
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automap_pro__srv__TriggerHBA_Response * msg = (automap_pro__srv__TriggerHBA_Response *)allocator.allocate(sizeof(automap_pro__srv__TriggerHBA_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automap_pro__srv__TriggerHBA_Response));
  bool success = automap_pro__srv__TriggerHBA_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automap_pro__srv__TriggerHBA_Response__Sequence__init(automap_pro__srv__TriggerHBA_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automap_pro__srv__TriggerHBA_Response * data = NULL;

  if (size) {
    data = (automap_pro__srv__TriggerHBA_Response *)allocator.zero_allocate(size, sizeof(automap_pro__srv__TriggerHBA_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automap_pro__srv__TriggerHBA_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automap_pro__srv__TriggerHBA_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automap_pro__srv__TriggerHBA_Response__Sequence__fini(automap_pro__srv__TriggerHBA_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automap_pro__srv__TriggerHBA_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automap_pro__srv__TriggerHBA_Response__Sequence * array = (automap_pro__srv__TriggerHBA_Response__Sequence *)allocator.allocate(sizeof(automap_pro__srv__TriggerHBA_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automap_pro__srv__TriggerHBA_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automap_pro__srv__TriggerHBA_Response__Sequence__destroy(automap_pro__srv__TriggerHBA_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automap_pro__srv__TriggerHBA_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automap_pro__srv__TriggerHBA_Response__Sequence__are_equal(const automap_pro__srv__TriggerHBA_Response__Sequence * lhs, const automap_pro__srv__TriggerHBA_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automap_pro__srv__TriggerHBA_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automap_pro__srv__TriggerHBA_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automap_pro__srv__TriggerHBA_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automap_pro__srv__TriggerHBA_Response * data =
      (automap_pro__srv__TriggerHBA_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automap_pro__srv__TriggerHBA_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automap_pro__srv__TriggerHBA_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automap_pro__srv__TriggerHBA_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
