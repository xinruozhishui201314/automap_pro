...
bool automap_pro__msg__mapping_status_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("automap_pro.msg._mapping_status_msg.MappingStatusMsg", full_classname_dest, 52) == 0);
  }
  automap_pro__msg__MappingStatusMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // gps_alignment_score
    PyObject * field = PyObject_GetAttrString(_pymsg, "gps_alignment_score");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->gps_alignment_score = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // map_entropy
    PyObject * field = PyObject_GetAttrString(_pymsg, "map_entropy");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->map_entropy = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // total_distance_m
...
{
  /* NOTE(esteve): Call constructor of MappingStatusMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("automap_pro.msg._mapping_status_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MappingStatusMsg");
  ...
  {  // gps_alignment_score
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->gps_alignment_score);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gps_alignment_score", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // map_entropy
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->map_entropy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "map_entropy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
